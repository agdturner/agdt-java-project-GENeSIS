...
//        //this.Generic_TestMemory no need to set this
    ...
    public GENESIS_AgentCollectionManager get_AgentCollectionManager(
        ...
        try {
            ...
            if (handleOutOfMemoryError) {
                ...
                initMemoryReserve(_GENESIS_Environment.HandleOutOfMemoryErrorFalse);
...
//                throw new OutOfMemoryError(message);
            ...
            if (handleOutOfMemoryError) {
                _GENESIS_Environment.clearMemoryReserve();
                long account;
                boolean createdRoom = false;
                while (!createdRoom) {
                    try {
                        ...
                        _GENESIS_Environment.initMemoryReserve(
                                HandleOutOfMemoryErrorFalse);
                        tryToEnsureThereIsEnoughMemoryToContinue(handleOutOfMemoryError);
                        createdRoom = true;
                    } catch (OutOfMemoryError b_OutOfMemoryError) {
