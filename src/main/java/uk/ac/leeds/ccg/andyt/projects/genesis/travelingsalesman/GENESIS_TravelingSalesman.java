 ...
 * @author geoagdt
 */
public class GENESIS_TravelingSalesman extends GENESIS_Object implements Serializable {
    ...
    protected GENESIS_TravelingSalesman(){}
    
    public GENESIS_TravelingSalesman(GENESIS_Environment ge){
        super(ge);
    }
    ...
    public GENESIS_TravelingSalesman(
