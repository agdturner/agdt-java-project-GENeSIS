 ...
 */
public class Compare_GENESIS_DemographicModel extends Abstract_GENESIS_Model {

    /**
     * Used for Logging
     */
    private static final String sourceClass = Compare_GENESIS_DemographicModel.class.getName();
    private static final String sourcePackage = Compare_GENESIS_DemographicModel.class.getPackage().getName();
    ...
    public static void main(String[] args) {
        try {
            ...
            String underscore = "_";
            Compare_GENESIS_DemographicModel instance = new Compare_GENESIS_DemographicModel();
...
//            }
    ...
    protected void generateComparisonPlots() {
        ...
        try {
            ...
            System.err.println(ex.getMessage() + " in " + Compare_GENESIS_DemographicModel.class.getName() + ".generateComparisonPlots()");
            Logger.getLogger(Compare_GENESIS_DemographicModel.class.getName()).log(Level.SEVERE, null, ex);
...
//                a_MiscarriageRate_File);
    ...
    public BigDecimal getSimilarity(
        ...
        // Set _GENESIS_Environment._Time
