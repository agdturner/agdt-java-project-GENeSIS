 ...
 */
public class GENESIS_ModelDemographic
        extends GENESIS_AbstractModelDemographic
        implements Serializable {

    /**
     * Used for Logging
     */
    private static final String sourceClass = GENESIS_ModelDemographic.class.getName();
    private static final String sourcePackage = GENESIS_ModelDemographic.class.getPackage().getName();
    ...
    public GENESIS_ModelDemographic(
            GENESIS_ModelDemographic a_Demographic_Aspatial_1) {
...
//        this._Fertility = a_Demographic_Aspatial_1._Fertility;
    ...
    public static void main(String[] args) {
        try {
            GENESIS_ModelDemographic m;
            m = new GENESIS_ModelDemographic();
...
//        }
        ...
        try {
            archiveDirectory_File = new File(
                    workspace_File,
                    GENESIS_ModelDemographic.class.getSimpleName()).getCanonicalFile();
        } catch (IOException e) {
            System.err.println(
                    e.toString()
        ...
        ge.Directory = archiveDirectory_File;
        ge.HandleOutOfMemoryError = true;
        /*
         * ---------------------------------------------------------------------
    ...
    public String run(
        ...
        /*
         * Initialise _GENESIS_Environment.Time using parameters.getStartYear()
...
//                _GENESIS_Environment.AgentEnvironment.getAgentCollectionManager(
//                _GENESIS_Environment.HandleOutOfMemoryError)._MaximumNumberOfAgentsPerAgentCollection;
//        AgentCollectionManager.MaximumNumberOfObjectsPerDirectory =
//                _GENESIS_Environment.AgentEnvironment.getAgentCollectionManager(
//                _GENESIS_Environment.HandleOutOfMemoryError).MaximumNumberOfObjectsPerDirectory;
        ...
        log(Level.FINE,
                ...
                + ge.getTotalFreeMemory(ge.HandleOutOfMemoryError));
...
//            this._Demographics._Migration.rationaliseMigrationData();
            ...
            run_Metadata.setStartYear((int) ge.Time.getYear());
            run_Metadata.setStartDay(ge.Time.getDayOfYear());
...
//                            AgentCollectionManager.getFemaleCollection_ID(
//                            a_Agent_ID,
//                            type,
//                            _GENESIS_Environment.HandleOutOfMemoryError);
//                    GENESIS_FemaleCollection a_FemaleCollection =
//                            AgentCollectionManager.getFemaleCollection(
//                            a_Collection_ID,
//                            type,
//                            _GENESIS_Environment.HandleOutOfMemoryError);
...
//                    Long a_Agent_ID = ite4.next();
//                    Long a_Collection_ID =
//                            AgentCollectionManager.getMaleCollection_ID(
//                            a_Agent_ID,
//                            type,
//                            _GENESIS_Environment.HandleOutOfMemoryError);
//                    GENESIS_MaleCollection a_MaleCollection =
//                            AgentCollectionManager.getMaleCollection(
//                            a_Collection_ID,
//                            type,
//                            _GENESIS_Environment.HandleOutOfMemoryError);
...
//            log(Level.INFO, message);
//            System.out.println(message);
//            message = "AgentCollectionManager.MaximumNumberOfObjectsPerDirectory "
//                    + AgentCollectionManager.MaximumNumberOfObjectsPerDirectory;
//            log(Level.INFO, message);
//            System.out.println(message);
//            _SeedDirectory_File = new File(
...
//            startYear = new Integer(seedRun_Metadata.getEndYear());
//            startDay = new Integer(seedRun_Metadata.getEndDay());
//            _GENESIS_Environment.Time = new GENESIS_Time(startYear, startDay);
//            //_GENESIS_Environment.Time.addDay();
//            int initialYear = new Integer(seedRun_Metadata.getInitialYear());
//            int initialDay = new Integer(seedRun_Metadata.getInitialDay());
...
//            run_Metadata.setInitialYear(seedRun_Metadata.getInitialYear());
//            run_Metadata.setInitialDay(seedRun_Metadata.getInitialDay());
//            run_Metadata.setStartYear((int) _GENESIS_Environment.Time.getYear());
//            run_Metadata.setStartDay(_GENESIS_Environment.Time.getDayOfYear());
//            // If input randomSeed_Long is negative then the simulation is 
//            // continued from the previous simulation.
//            if (randomSeed_Long < 0) {
//                run_Metadata.setPseudoRandomNumberSeed(randomSeed_Long);
...
//            System.out.println(message);
//            // LivingFemales
//            AgentCollectionManager.setLivingFemaleDirectory(
//                    new File(
//                    _ResultDataDirectory_File,
//                    "LivingFemales"));
//            File previousFemaleDirectory_File = new File(
...
//                    lastLivingFemaleCollection.getMaxAgentID();
//            // LivingMales
//            AgentCollectionManager.setLivingMaleDirectory(
//                    new File(
//                    _ResultDataDirectory_File,
//                    "LivingMales"));
//            File previousMaleDirectory_File = new File(
...
//             * to do this?
//             */
//            AgentCollectionManager.setDeadFemaleDirectory(
//                    new File(
//                    _ResultDataDirectory_File,
//                    "DeadFemales"));
//            previousFemaleDirectory_File = new File(
...
//             * do this?
//             */
//            AgentCollectionManager.setDeadMaleDirectory(
//                    new File(
//                    _ResultDataDirectory_File,
//                    "DeadMales"));
//            previousMaleDirectory_File = new File(
...
//            }
        ...
        run0();
        run_Metadata.setEndYear((int) ge.Time.getYear());
        run_Metadata.setEndDay(ge.Time.getDayOfYear());
    ...
    public void run0() {
        ...
        ge.AgentEnvironment.get_AgentCollectionManager(ge.HandleOutOfMemoryError).swapToFile_AgentCollections(ge.HandleOutOfMemoryError);
        File outputFile;
        /*
...
//                    HandleOutOfMemoryError);
        ...
        // Female
        iterator = _GENESIS_AgentCollectionManager.LivingFemales.keySet().iterator();
        while (iterator.hasNext()) {
            Long a_ID = iterator.next();
            GENESIS_FemaleCollection c;
            c = _GENESIS_AgentCollectionManager.LivingFemales.get(a_ID);
            if (c != null) {
        ...
        // Male
        iterator = _GENESIS_AgentCollectionManager.LivingMales.keySet().iterator();
        while (iterator.hasNext()) {
            Long a_ID = iterator.next();
            GENESIS_MaleCollection c;
            c = _GENESIS_AgentCollectionManager.LivingMales.get(a_ID);
            if (c != null) {
                c.write(false); // Has to be false otherwise a concurrent modification exception may occur!
                c = null;
            }
    ...
    public void init_Demographics() {
        ...
        try {
            ...
            long age;
            Iterator<Long> ite3;
            ite3 = _GENESIS_AgentCollectionManager.LivingFemales.keySet().iterator();
            while (ite3.hasNext()) {
                ...
                while (ite2.hasNext()) {
                    ...
                    GENESIS_Female female = _GENESIS_AgentCollectionManager.getFemale(a_Agent_ID,
                            GENESIS_Person.getTypeLivingFemale_String(),
                            HandleOutOfMemoryError);
                    female.ge = ge;
            ...
            ite3 = _GENESIS_AgentCollectionManager.LivingMales.keySet().iterator();
            while (ite3.hasNext()) {
                ...
                while (ite2.hasNext()) {
                    Long a_Agent_ID = ite2.next();
                    GENESIS_Male male = _GENESIS_AgentCollectionManager.getMale(a_Agent_ID,
                            GENESIS_Person.getTypeLivingMale_String(),
                            HandleOutOfMemoryError);
                    male.ge = ge;
...
//                        a_VectorPoint2D,
//                        _GENESIS_Environment.HandleOutOfMemoryError);
//                Long a_Agent_ID = a_Female.getAgentID(
//                        _GENESIS_Environment.HandleOutOfMemoryError);
...
//                        a_VectorPoint2D,
//                        _GENESIS_Environment.HandleOutOfMemoryError);
//                Long a_Agent_ID = a_Male.getAgentID(
//                        _GENESIS_Environment.HandleOutOfMemoryError);
 ...
 birthSubregionID, secondly thisSubregionID.
    ...
    public GENESIS_Female getNewInitialisedFemale(
        ...
        GENESIS_Female result = getNewInitialisedFemale(
                ...
                subregionLivingFemaleIDs,
                subregionNotPregnantFemaleIDs);
        result.ResidentialSubregionIDs.add(birthSubregionID);
        result.ResidentialSubregionIDs.add(thisSubregionID);
        return result;
    }
    ...
    public GENESIS_Female getNewInitialisedFemale(
        ...
        result = ge._PersonFactory.createFemale(age,
                ...
                null,
                ge.HandleOutOfMemoryError);
        Long a_Agent_ID = result.getAgentID(ge.HandleOutOfMemoryError);
...
//                    _GENESIS_Environment.HandleOutOfMemoryError);
//            //a_Male.write();
//            _LivingMaleIDs.add(a_Male.getAgentID(
//                    _GENESIS_Environment.HandleOutOfMemoryError));
//        }
...
//                            roundingMode, startAgeOfEndYearInterval);
    ...
    public HashSet<Future> simulate(
        ...
        boolean isMigration;
        //_GENESIS_Environment.Time.addDay();
//        int startYear = (int) _GENESIS_Environment.Time.getYear();
//        int endYear = startYear + years;
        int startDay = ge.Time.getDayOfYear();
        //_GENESIS_Environment.Time.subtractDay();
...
//                            }
//                        } else {
//                            if (a_Male.getCopyOfAge() == null) {
//                                System.err.println("a_Male.getCopyOfAge() is null, Agent_ID " + a_Agent_ID + ", Collection_ID " + a_Collection_ID);
//                            } else {
//                            }
//                        }

                            long age = a_Male.getCopyOfAge().getAgeInYears_long(ge.Time);
                            GENESIS_AgeBound ageBound = new GENESIS_AgeBound(age);
...
//                        if (!_regionIDs.containsKey(femaleRegionID)) {
                            ...
                            a_Female.ResidentialSubregionIDs.add(destinationSubregionID);
...
//                            }
                                ...
                                try {
//                            //debug
//                            if (a_Female.getAgentID(true ) == 499029) {
//                                int debug = 1;
//                            }
...
//                    }
                                    ...
                                    age = a_Female.getCopyOfAge().getAgeInYears_long(ge.Time);
...
//                        if (!_regionIDs.containsKey(maleRegionID)) {
                                ...
                                a_Male.ResidentialSubregionIDs.add(destinationSubregionID);
...
//                    }
                                    ...
                                    age = a_Male.getCopyOfAge().getAgeInYears_long(ge.Time);
                                    ageBound = new GENESIS_AgeBound(age);
//                            TreeMap<String, GENESIS_Population> originRegionPopulation;
//                            originRegionPopulation = _Demographics._Population.get(originRegionID);
// Origin accounting already done
...
//                + ", totalDeathsInYear " + totalDeathsInYear
        ...
        //_GENESIS_Environment.swapToFile_AgentCollections(HandleOutOfMemoryError);
...
//                _GENESIS_Environment.RoundingModeForPopulationProbabilities)) {
        if (Generic_BigDecimal.randomUniformTest(_RandomArray[5],
            ...
            if (collectionEmpty) {
                ...
                // Remove Mapping from AgentCollectionManager.LivingFemales
                _GENESIS_AgentCollectionManager.LivingFemales.remove(a_Collection_ID);
            }
            // Account Populations
            //GENESIS_AgeBound singleYearAgeBound = new GENESIS_AgeBound(a_Female.getCopyOfAge().getAgeInYears());
            // Account subregionPopulation._FemaleAgeBoundPopulationCount_TreeMap
            GENESIS_Collections.addTo_TreeMap_AgeBound_BigDecimal(subregionPopulation._FemaleAgeBoundPopulationCount_TreeMap,
                    ageBound,
                    minusOne_BigDecimal,
...
//                _GENESIS_Environment.RoundingModeForPopulationProbabilities)) {
        if (Generic_BigDecimal.randomUniformTest(_RandomArray[5],
            ...
            if (collectionEmpty) {
                ...
                // Remove Mapping from AgentCollectionManager.LivingMales
                _GENESIS_AgentCollectionManager.LivingMales.remove(a_Collection_ID);
            }
            // Account Populations
            //GENESIS_AgeBound singleYearAgeBound = new GENESIS_AgeBound(a_Male.getCopyOfAge().getAgeInYears());
            // Account subregionPopulation._MaleAgeBoundPopulationCount_TreeMap
            GENESIS_Collections.addTo_TreeMap_AgeBound_BigDecimal(subregionPopulation._MaleAgeBoundPopulationCount_TreeMap,
                    ageBound,
                    minusOne_BigDecimal,
...
//                        }
                        ...
                        // Account
                        GENESIS_AgeBound yearAgeBound = new GENESIS_AgeBound(female.getCopyOfAge().getAgeInYears(ge.Time));
                        ...
                        //females.add(female);
                        //regionLivingFemaleIDs.get(subregionID).add(female.getAgentID(HandleOutOfMemoryError));
                        result++;
                    }
//                    GENESIS_Collections.addTo_TreeMap_AgeBound_BigDecimal(
//                            regionTotalImmigration,
...
//                        }
                        ...
                        // Account
                        GENESIS_AgeBound yearAgeBound = new GENESIS_AgeBound(male.getCopyOfAge().getAgeInYears(ge.Time));
                        ...
                        //males.add(male);
                        //regionLivingMaleIDs.get(subregionID).add(male.getAgentID(HandleOutOfMemoryError));
                        result++;
                    }
//                    GENESIS_Collections.addTo_TreeMap_AgeBound_BigDecimal(
//                            regionTotalImmigration,
...
//                    }
    ...
    public Object[] simulateBirth(
            ...
            TreeSet<Long> notPregnantFemaleIDs) {
        Object[] result = null;
        if (a_Female.TimeDueToGiveBirth.compareTo(ge.Time) == 0) {
            result = a_Female.giveBirthSimple(ge.HandleOutOfMemoryError);
            Iterator<Long> ite;
            Long agent_ID;
...
//                    babyBoyCount);
    ...
    public void updateSubregionNearlyDuePregnantFemaleIDs(
        ...
        long differenceInDays = ge.Time.getDifferenceInDays_long(a_Female.TimeDueToGiveBirth);
                ...
                while (ite2.hasNext()) {
                    ...
                    while (ite3.hasNext()) {
                        ...
                        GENESIS_Female a_Female = _GENESIS_AgentCollectionManager.getFemale(a_Agent_ID,
                                ...
                                ge.HandleOutOfMemoryError);
                        long differenceInDays = ge.Time.getDifferenceInDays_long(a_Female.TimeDueToGiveBirth);
                        //long differenceInDays = a_Female.TimeDueToGiveBirth.getDifferenceInDays_long(_GENESIS_Environment.Time);
                        if (differenceInDays <= NearlyDueNumberOfDaysTillDueDate) {
                            subregionNearlyDuePregnantFemaleIDs.add(a_Agent_ID);
                        }
                    }
...
//                    // debug
//                    if (a_Female.getAgentID(false) == 58061) {
//                        int debug = 1;
//                        System.out.println(a_Female);
//                    }
...
//                    }
                    ...
                    GENESIS_Time age_Time = new GENESIS_Time(age.getAge_Time(ge.Time));
...
//                double age_double = age.getAge_double(_GENESIS_Environment.Time);
////                long ageInYears = age.getAgeInYears(_GENESIS_Environment.Time);
////                long ageInDays = age.getAgeInDays(_GENESIS_Environment.Time);
